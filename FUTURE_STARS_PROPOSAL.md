...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1a237e', 'primaryTextColor': '#fff', 'primaryBorderColor': '#1a237e', 'lineColor': '#1a237e', 'secondaryColor': '#e8eaf6', 'tertiaryColor': '#c5cae9'}}}%%
graph TD
    title[FUTURE STARS ACADEMY]
    title --> vision["Vision: Africa's leading innovation academy"]
    title --> mission["Mission: Empower learners through project-based education"]
    title --> motto["Motto: Learn. Build. Innovate. Impact."]
    
    style title fill:#1a237e,color:#fff,font-size:18px
    style vision fill:#283593,color:#fff
    style mission fill:#3949ab,color:#fff
    style motto fill:#5c6bc0,color:#fff
```
...
```mermaid
flowchart LR
    P[Real Community Problem] --> R[Research & Analysis]
    R --> D[Design Thinking]
    D --> P2[Prototyping]
    P2 --> I[Implementation]
    I --> B[Business Creation]
    B --> I2[Impact Measurement]
    I2 --> P
    
    style P fill:#d32f2f,color:#fff
    style R fill:#f57c00,color:#fff
    style D fill:#fbc02d,color:#fff
    style P2 fill:#388e3c,color:#fff
    style I fill:#1976d2,color:#fff
    style B fill:#7b1fa2,color:#fff
    style I2 fill:#0097a7,color:#fff
```
...
```mermaid
flowchart TD
    subgraph PROBLEMS[Systemic Challenges in Lesotho]
        A[High Youth Unemployment]
        B[Skills Mismatch:<br/>Education vs Industry]
        C[Limited Practical<br/>STEM Education]
        D[Low Entrepreneurship<br/>Rates]
        E[Limited AI &<br/>Digital Skills Access]
        F[Few Innovation<br/>Hubs for Youth]
        G[Growing<br/>E-Waste Crisis]
        H[Limited Commercialization<br/>of Student Ideas]
    end
    
    subgraph ROOT[Root Causes]
        I[Outdated Curricula]
        J[Theory-Heavy<br/>Teaching Methods]
        K[Limited Industry<br/>Partnerships]
        L[No Innovation<br/>Ecosystem for Youth]
    end
    
    subgraph IMPACT[National Impact]
        M[Dependency on<br/>Government Employment]
        N[Brain Drain]
        O[Slow Economic<br/>Diversification]
        P[Limited Global<br/>Competitiveness]
    end
    ...
    style PROBLEMS fill:#ffebee,color:#333
    style ROOT fill:#fff3e0,color:#333
    style IMPACT fill:#e8f5e9,color:#333
```
...
```mermaid
flowchart TB
    subgraph P[Programme Pillars]
        P1[AI] & P2[Software] & P3[Robotics] & P4[Renewable Energy]
        P5[Agriculture] & P6[Entrepreneurship] & P7[Fashion Tech]
        P8[Baking & Food] & P9[Digital Media] & P10[Electronics]
    end
    subgraph D[Delivery]
        D1[After-school] & D2[Weekend Academy] & D3[Holiday Camps]
        D4[Online Platform] & D5[Innovation Clubs] & D6[Corporate Training]
    end
    subgraph L[Learning Process]
        L1[Identify Problem] --> L2[Research] --> L3[Design & Prototype]
        L2 --> L3
        L3 --> L4[Build & Implement] --> L5[Launch & Commercialize]
    end
    subgraph O[Outcomes]
        O1[Prototype / App / Business / Community Project / Innovation Passport]
    end
    P --> D --> L --> O
```
...
```mermaid
pie title Phase One Target Market Distribution
    "Learners 10-14 (Junior)" : 45
    "Learners 15-18 (Senior)" : 35
...
```mermaid
flowchart TD
    subgraph P1[Primary: Learner]
        L1[Age: 10-18]
        L2[Attends existing school]
        L3[Curious about tech]
        L4[Needs future skills]
        L5[Wants hands-on learning]
    end
    
    subgraph P2[Secondary: Parent]
        PA1[Working professional]
        PA2[Concerned about child's future]
        PA3[Seeks practical education]
        PA4[Willing to invest in enrichment]
    end
    
    subgraph P3[Tertiary: Institution]
        INST1[Schools seeking innovation]
        INST2[Government ministries]
        INST3[NGOs & Development partners]
        INST4[Corporate sponsors]
    end
    
    P1 --> VALUE[Value Proposition:<br/>Real skills, Real products, Real impact]
    P2 --> VALUE
    P3 --> VALUE
```
...
```mermaid
flowchart TB
    subgraph PROJECTS[Flagship Innovation Projects]
        S1[Smart Light &<br/>Energy Lab]
        S2[Smart Agriculture<br/>Lab]
        S3[Smart Water<br/>Lab]
        S4[Smart Fashion<br/>Lab]
        S5[Smart Bakery]
        S6[Smart Village<br/>Programme]
        S7[AI for Community<br/>Development]
        S8[Robotics for<br/>Rural Communities]
    end
    
    subgraph IMPACT[Community Impact Areas]
        I1[Energy Access]
        I2[Food Security]
        I3[Water Management]
        I4[Job Creation]
        I5[Digital Inclusion]
        I6[Environmental<br/>Sustainability]
    end
    ...
    style PROJECTS fill:#fce4ec,color:#333
    style IMPACT fill:#e8f5e9,color:#333
```
...
```mermaid
pie title Existing Asset Allocation (M230,500 Total)
    "ICT Equipment (10 Desktops, Printer, Networking)" : 85000
    "Office Furniture (Desks, Chairs, Filing)" : 25000
    "Vocational Equipment (Oven, Broiler)" : 35000
    "Intellectual Property (Curriculum, Frameworks)" : 55000
    "Digital Ecosystem (Platforms, Systems)" : 20000
    "Other (Brand, Research, Planning)" : 10500
```
...
```mermaid
pie title Use of Funds - M300,000 Investment
    "ICT Expansion" : 70000
    "Innovation Lab Equipment" : 55000
    "Robotics & AI Kits" : 35000
    "Furniture & Classroom Setup" : 30000
    "Digital Platform Development" : 30000
    "Marketing & Outreach" : 20000
...
flowchart TB
    subgraph REVENUE[Revenue Streams]
        F1[Student Membership<br/>Fees] --> BASE[Base Revenue]
        F2[Holiday Innovation<br/>Camps] --> EVENT[Event Revenue]
        F3[Saturday<br/>Workshops] --> EVENT
        F4[School Innovation<br/>Clubs] --> PARTNER[Partnership Revenue]
        F5[Corporate<br/>Training] --> PARTNER
        F6[Digital Learning<br/>Platform] --> DIGITAL[Digital Revenue]
        F7[Consulting<br/>Services] --> PARTNER
        F8[Student Product<br/>Sales] --> COMM[Commercial Revenue]
        F9[Grants &<br/>Sponsorships] --> GRANT[Grant Revenue]
        F10[Innovation<br/>Competitions] --> EVENT
    end
    
    BASE --> TOTAL[Total Revenue]
    EVENT --> TOTAL
    PARTNER --> TOTAL
    DIGITAL --> TOTAL
    COMM --> TOTAL
    ...
    style REVENUE fill:#e3f2fd,color:#333
...
```mermaid
pie title Year 1 Revenue Breakdown (M691,000)
    "Student Fees" : 168
    "Holiday Camps" : 90
    "Saturday Workshops" : 120
    "School Clubs" : 48
    "Corporate Training" : 60
    "Digital Platform" : 36
    "Consulting" : 40
    "Product Sales" : 24
...
```mermaid
flowchart LR
    subgraph READY[Already Established]
        R1[✓ Equipment & Infrastructure]
        R2[✓ Curriculum & Learning Materials]
        R3[✓ Project Frameworks]
        R4[✓ Founder Investment]
        R5[✓ Innovation Model]
        R6[✓ Business Strategy]
        R7[✓ Technology Roadmap]
    end
    
    subgraph PENDING[Post-Funding]
        P1[Laboratory Expansion]
        P2[Team Recruitment]
        P3[Marketing Launch]
        P4[Platform Enhancement]
        P5[Partnership Formalization]
    end
    
    READY --> LAUNCH[LAUNCH READY]
    PENDING --> LAUNCH
    
    style READY fill:#e8f5e9,color:#333
    style PENDING fill:#fff3e0,color:#333
    style LAUNCH fill:#1a237e,color:#fff
```
...
xychart-beta
    title "Three-Year Financial Growth (M)"
    x-axis ["Year 1", "Year 2", "Year 3"]
    y-axis "Amount (Maloti)" 0 --> 3000000
    bar [691000, 1384000, 2400000]
    line [460000, 650000, 900000]
```
...
```mermaid
pie title Year 1 Operating Expenses (M460,000)
    "Staff Stipends & Salaries" : 180
    "Rent & Utilities" : 72
...
flowchart TB
    subgraph INPUTS[Inputs]
        INV[M300,000 Investment]
        ASSETS[Existing Assets<br/>M230,500]
        CURR[Curriculum & IP]
        PEOPLE[Founder + Team]
    end
    
    subgraph OUTPUTS[3-Year Targets]
        O1[270+ Learners Trained]
        O2[25 Partner Schools]
        O3[30 Student Businesses]
        O4[100+ Community Projects]
        O5[5,000+ Digital Platform Users]
    end
    
    subgraph OUTCOMES[Outcomes]
        OC1[Reduced Youth<br/>Unemployment]
        OC2[Increased STEM<br/>Participation]
        OC3[Innovation<br/>Culture]
        OC4[Entrepreneurial<br/>Ecosystem]
    end
    
    subgraph IMPACT[SDG Alignment]
        SDG4[SDG 4: Quality Education]
        SDG8[SDG 8: Decent Work &<br/>Economic Growth]
        SDG9[SDG 9: Industry, Innovation<br/>& Infrastructure]
        SDG10[SDG 10: Reduced<br/>Inequalities]
    end
    ...
    style INPUTS fill:#e3f2fd,color:#333
    style OUTPUTS fill:#e8f5e9,color:#333
    style OUTCOMES fill:#fff3e0,color:#333
    style IMPACT fill:#f3e5f5,color:#333
```
...
```mermaid
flowchart TB
    subgraph BENEFITS[Investment Benefits]
        B1[Youth Employment<br/>Impact] --> VC1[Direct: Jobs created by student ventures<br/>Indirect: Improved employability]
        B2[Entrepreneurship<br/>Development] --> VC2[Culture shift from job-seeking<br/>to opportunity creation]
        B3[Innovation<br/>Ecosystem] --> VC3[Pipeline of solutions to<br/>local challenges]
        B4[STEM & AI<br/>Readiness] --> VC4[Nation prepared for the<br/>Fourth Industrial Revolution]
        B5[Sustainable<br/>Development] --> VC5[Aligned with Lesotho's<br/>national development goals]
        B6[Economic<br/>Diversification] --> VC6[New industries, new revenue,<br/>new opportunities]
        B7[Technology<br/>Adoption] --> VC7[Digital skills diffusion across<br/>communities]
        B8[National<br/>Competitiveness] --> VC8[Lesotho's talent competes<br/>regionally and globally]
    end
    
    style BENEFITS fill:#e8f5e9,color:#333
```
...
```mermaid
flowchart LR
    M1["M1 Invested"] --> MUL[Multiplier Engine]
    MUL --> E1["M3.5 Direct Economic Activity"]
    MUL --> E2["5+ Learners Impacted"]
    MUL --> E3["2 Community Projects"]
    MUL --> E4["0.5 Student Businesses<br/>(2 investments = 1 business)"]
    MUL --> E5["M8 Social Value<br/>(SROI Estimate)"]
    
    style M1 fill:#d32f2f,color:#fff
    style MUL fill:#1a237e,color:#fff
    style E1 fill:#388e3c,color:#fff
    style E2 fill:#f57c00,color:#fff
    style E3 fill:#0097a7,color:#fff
    style E4 fill:#7b1fa2,color:#fff
    style E5 fill:#fbc02d,color:#333
```
...
```mermaid
flowchart TB
    subgraph HIGH[High Impact Threats]
        T1[Economic Downturn<br/>↓ Enrolment]
        T2[Key Person<br/>Dependency]
        T3[Funding<br/>Shortfall]
    end
    
    subgraph MEDIUM[Medium Impact Threats]
        T4[Competitor<br/>Entry]
        T5[Technology<br/>Obsolescence]
        T6[Staff<br/>Retention]
    end
    
    subgraph LOW[Low Impact Threats]
        T7[Regulatory<br/>Changes]
        T8[Cyber<br/>Incidents]
        T9[Facility<br/>Issues]
    end
    
    style HIGH fill:#fce4ec,color:#333
    style MEDIUM fill:#fff3e0,color:#333
    style LOW fill:#e8f5e9,color:#333
```
...
```mermaid
gantt
    title Future Stars Academy - 24-Month Implementation Plan
    dateFormat  YYYY-MM-DD
    axisFormat  %b %Y
    
    section Phase 1: Setup (Months 1-3)
    Legal Registration & Compliance    :a1, 2026-08-01, 45d
    Facility Fit-out & Lab Setup       :a2, 2026-08-15, 60d
    ICT & Equipment Installation       :a3, 2026-09-01, 45d
    Digital Platform Launch            :a4, 2026-09-01, 60d
    Staff Recruitment & Training       :a5, 2026-09-15, 45d
    
    section Phase 2: Launch (Months 4-6)
    Marketing Campaign Launch          :b1, 2026-11-01, 45d
    School Partnership Onboarding      :b2, 2026-11-01, 60d
    Pilot Programme (20 learners)      :b3, 2026-11-15, 45d
    Open Day & Community Event         :b4, 2026-12-01, 14d
    
    section Phase 3: Operations (Months 7-12)
    Full Programme Rollout             :c1, 2027-01-01, 180d
    Holiday Innovation Camp #1         :c2, 2027-01-15, 14d
    Innovation Challenge #1            :c3, 2027-03-01, 30d
    Parent Engagement Forum            :c4, 2027-03-15, 7d
    Mid-Year Review & Adjustment       :c5, 2027-06-01, 30d
    
    section Phase 4: Growth (Months 13-24)
    Year 2 Expansion Planning          :d1, 2027-08-01, 60d
    New Programme Development          :d2, 2027-09-01, 90d
    Corporate Training Launch          :d3, 2027-10-01, 60d
    Innovation Expo                    :d4, 2027-11-01, 30d
    Regional Outreach                  :d5, 2028-01-01, 180d
```
